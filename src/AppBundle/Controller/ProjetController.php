...
class ProjetController extends Controller
{
    ...
    public function newProjetAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $shortDescription = $this->createShortDescription($projet->getDescriptionProjet());
    ...
    public function editProjetAction(Projet $projet, Request $request)
    {
        ...
        {
            $projet->setShortDescriptionProjet($this->createShortDescription($projet->getDescriptionProjet()));
            $em = $this->getDoctrine()->getManager();
            $em->flush();
    ...
    {
        $shortDescription = substr($description, 0, 251);
